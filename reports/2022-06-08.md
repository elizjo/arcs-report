...
+ learned shortcuts to navigate 
  + f- reset view, e- rotate objects, w- translate objects, ctrl + spbar content drawer)
  + top left changes user view mode, top right concerns camera movement/ objects)
  + most important modes (on left corner, modeling and select)
  + (to import pre-built assets) content drawer -> content folder -> left click -> import to game
