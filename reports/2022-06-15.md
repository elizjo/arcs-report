...
6/17 -> try setting up creek landscape (3:17) maybe?
...
+ since no reality capture, took reference photos + used google earth for 2D view from above to estimate scale
#### Possible Approaches to Build Outdoor Spaces @ Pomona
+ find plants, grass, rocks on Quixel Bridge
+ reality capture, how much/ scope of useage? 
